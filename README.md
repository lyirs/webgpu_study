...
| vol1_oneCube_image_textureSampling  | 一个旋转的正方体与图片纹理采样                                      |
| vol1_oneCube_canvas_textureSampling | 一个旋转的正方体与画布纹理采样                                      |
| vol1_oneCube_video_textureSampling  | 一个旋转的正方体与视频纹理采样                                      |
